...
FEATURE_FLAGS = {"ALERT_REPORTS": True,"EMBEDDED_SUPERSET": True,"EMBEDDABLE_CHARTS": True,"ENABLE_JAVASCRIPT_CONTROLS": True,"DASHBOARD_CROSS_FILTERS": True,"DRILL_TO_DETAIL": True}
